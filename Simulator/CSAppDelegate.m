...
- (IBAction)loadDataButton:(id)sender
{
    ...
    fileContent = [NSString stringWithContentsOfFile:path usedEncoding:&encoding error:NULL];
    NSLog(@"%@", fileContent);
    ...
    NSLog(@"Start: %lu end: %lu", startOfDimension.location, endOfDimension.location);
    ...
    NSLog(@"Start: %lu length: %lu", dimensionRange.location, dimensionRange.length);
